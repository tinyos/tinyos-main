...
configuration ReadLqiC {
  ...
  components RFXLinkReadLqiC, Ieee154MessageC;
  ReadLqi = RFXLinkReadLqiC;
  RFXLinkReadLqiC.SubLqi -> Ieee154MessageC.PacketLinkQuality;
  RFXLinkReadLqiC.SubRssi -> Ieee154MessageC.PacketRSSI;
#else
